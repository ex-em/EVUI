...
export default {
  ...
  components: {
    ...
    Column: {
      description:
        '세로 형태로 사용할 수 있으며 각 Series별, data별로 색상을 직접 지정할 수 있습니다.',
      component: Column,
      parsedData: parse(ColumnRaw).descriptor,
    },
    Horizontal: {
      description:
        '가로 형태로 사용할 수 있으며 Series별로 데이터 라벨 표시 여부 및 속성을 설정 할 수 있습니다.',
      component: Horizontal,
      parsedData: parse(HorizontalRaw).descriptor,
    },
    Stack: {
      description:
        '동일한 그룹으로 묶인 series들의 데이터를 한 막대에 누적하여 표현할 수 있습니다.',
      component: Stack,
    ...
    Time: {
      description:
        '실시간으로 데이터를 받아 표현할 수 있으며, 가장 큰 값에 해당하는 막대위에 Tip을 붙일 수 있습니다.',
      component: Time,
