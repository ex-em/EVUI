<template>
  ...
  <div class="case">
    <p class="case-title">Position</p>
    <ev-button @click="showTopRight"> Show Top-Right </ev-button>
    <ev-button @click="showTopLeft"> Show Top-Left </ev-button>
    <ev-button @click="showBottomRight"> Show Bottom-Right </ev-button>
    <ev-button @click="showBottomLeft"> Show Bottom-Left </ev-button>
  </div>
  <div class="case">
  ...
  <div class="case">
    <p class="case-title">Hide Close Button</p>
  ...
  <div class="case">
    <p class="case-title">Click Event</p>
    <ev-button @click="showOnClick"> Show onClick </ev-button>
    <div class="description">
      <span class="badge"> After click </span>
      {{ onClickMsg }}
    </div>
  </div>
  <div class="case">
    <p class="case-title">Close Event</p>
    <ev-button @click="showOnClose"> Show onClose </ev-button>
    <div class="description">
      <span class="badge"> After close </span>
      {{ onCloseMsg }}
    </div>
  </div>
  <div class="case">
...
export default {
  setup() {
    ...
    const showSuccess = () => {
      ctx.$notify({
        message: 'Success! This is an Success type notification.',
        type: 'success',
      });
    };
    const showWarning = () => {
      ctx.$notify({
        message: 'Warning. This is an Warning type notification.',
        type: 'warning',
      });
    };
    const showError = () => {
      ctx.$notify({
        message: 'Error. This is an Error type notification.',
        type: 'error',
      });
    };
    ...
    const onClickMsg = ref();
    const showOnClick = () => {
      ctx.$notify({
        message: 'You can set the action after clicking!',
        showClose: true,
        onClick: () => {
          onClickMsg.value = 'You can set the action after clicking!';
        },
      });
    };
