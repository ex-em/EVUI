...
import TooltipHtml from './example/TooltipHtml';
import TooltipHtmlRaw from '!!raw-loader!./example/TooltipHtml';
...
export default {
  ...
  components: {
    ...
    'Custom Tooltip': {
      ...
      component: TooltipHtml,
      parsedData: parseComponent(TooltipHtmlRaw),
    },
    'Plot line & Plot band': {
