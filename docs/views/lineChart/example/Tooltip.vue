  ...
  setup() {
    ...
    const chartData = reactive({
      series: {
        ...
        series21: {
          name: 'series#21__long____long____long____long____long____long____long____long____long____long____long____long____long____long____long____long____long____long__(end)',
          point: false,
        },
      },
      labels: [],
