  ...
  export default {
    ...
    setup() {
      ...
      const chartData = reactive({
        series: {
          series1: { name: 'series#1', interpolation: 'linear', passingValue: null, point: false, fill: false },
          series2: { name: 'series#1', interpolation: 'linear', passingValue: null, show: false, fill: false },
        },
        labels: [
          dayjs(time),
