    ...
    data() {
      return {
        ...
        components: [{
          title: 'Default',
          component: Default,
          url: './pages/selectbox/examples/default.vue',
