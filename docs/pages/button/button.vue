<template>
  <div>
    ...
    />
    <ApiView
      :url="'./docs/pages/button/api/button.md'"
    />
  </div>
</template>
    ...
    data() {
      return {
        ...
        components: [{
          title: 'Type',
          component: Type,
          url: './docs/pages/button/examples/type.vue',
          ...
          title: 'Size',
          component: Size,
          url: './docs/pages/button/examples/size.vue',
          ...
          title: 'Shape',
          component: Shape,
          url: './docs/pages/button/examples/shape.vue',
          ...
          title: 'Disabled',
          component: Disabled,
          url: './docs/pages/button/examples/disabled.vue',
