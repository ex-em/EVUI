...
<script>
  import LineBar from './examples/line.bar';
  import LineStackBar from './examples/line.stackbar';
  import StackLineBar from './examples/stackline.bar';
  import StackLineStackBar from './examples/stackline.stackbar';
