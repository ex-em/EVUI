        ...
        data () {
            ...
            return {
                gridColumns: [
                    ...
                    {dataIndex: 'col6', name: 'column6'    , useOrder:false, draggable: false, width: 150, visible: true, type: 'string'},
                    {dataIndex: 'col7', name: 'column7'    , useOrder:false, draggable: false, width: 150, visible: true, type: 'string'},
                    {dataIndex: 'col8', name: 'column8'    , useOrder:false, draggable: false, width: 150, visible: true, type: 'string'},
                ],
                rowData : tempData
            }
        },
