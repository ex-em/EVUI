<template>
  <div>
    <div style="height:400px;">
      ...
      <div style="float:left;width:25%; padding:2%; font-size: 0.8rem">
    ...
    <div style="height:400px;">
      <div style="margin:15px; font-size: 0.75rem">
        <span>Data Record : </span>
        <button @click="dataRecordChange2(1000)">1K</button>
        <button @click="dataRecordChange2(5000)">5K</button>
        <button @click="dataRecordChange2(10000)">10K</button>
      </div>
...
//                        categories: ['Jan', 'Feb', 'Mar'],//, 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
    ...
    methods : {
      legendPositionChange: function(position){
        ...
        if(this.Scatter.chartOptions2.legend == undefined){
          this.Scatter.chartOptions2.legend = {}
        }

        if(this.Column.chartOptions.legend == undefined){
          this.Column.chartOptions.legend = {}
        }

        if(this.StackBar.chartOptions.legend == undefined){
      ...
      dataRecordChange2: function(dataCnt){
        let startTime = new Date(),
          mockArray = ['n01', 'n02', 'n03', 'n04', 'n05', 'n06', 'n07', 'n08', 'n09', 'n10'];
