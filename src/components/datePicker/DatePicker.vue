<template>
  ...
  >
    <div ref="datePickerWrapper" class="ev-date-picker__wrapper">
      ...
      <template v-else-if="$props.mode === 'dateMulti' || !$props.enableTextInput">
        <div class="ev-date-picker-tag-wrapper" @click="clickSelectInput">
          <span class="ev-date-picker-prefix-icon">
            <i class="ev-icon-calendar" />
          </span>
          <input
          ...
          <template v-else>
            <div v-if="mv[0]" class="ev-select-tag num">
      ...
      <template v-else>
        <div class="ev-date-picker-input-wrapper" @click="clickSelectInput">
          <span class="ev-date-picker-prefix-icon">
            <i class="ev-icon-calendar" />
          </span>
          <input
      ...
      <div class="ev-date-picker-dropbox-wrapper">
        ...
        >
          <div v-if="usedShortcuts.length" class="ev-date-picker-dropbox__button-layout">
            <ev-button
          ...
          <div v-if="usedShortcuts.length" class="ev-date-picker-dropbox__divider" />
          <div :class="{ 'ev-date-picker-dropbox__calendar': usedShortcuts.length }">
            <ev-calendar
              key="fromCalendar"
              v-model="mv"
              :mode="$props.mode"
