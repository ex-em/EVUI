        ...
        data () {
            return {
                ...
                gridColumns: [
                    ...
                    {dataIndex: 'col6', name: 'column6', width: 150, visible: true, type: 'string'},
                    {dataIndex: 'col7', name: 'column7', width: 150, visible: true, type: 'string'},
                    {dataIndex: 'col8', name: 'column8', width: 150, visible: true, type: 'string'}
                ],
                rowData : [
