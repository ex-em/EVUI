        ...
        data () {
            return {
                ...
                gridColumns: [
                    ...
                    {dataIndex: 'col2', name: 'column2', width: 200, visible: true, type: 'number', draggable: true},
                    {dataIndex: 'col3', name: 'column3', width: 150, visible: true, type: 'string', draggable: true},
